...
class GoodsReceiptModelViewTest(APITestCase):
	...
	def test_get_valid_goods_receipt(self):
		# Getting goods receipt with id 1
		response = self.client.get(reverse("goods_receipt:goods_receipt", args=[1]))
		self.assertEqual(response.status_code, 200)
		data = response.data["goods_receipt_info"]
	...
	def test_get_invalid_goods_receipt(self):
		# Getting goods receipt with id 2 which does not exist
		response = self.client.get(reverse("goods_receipt:goods_receipt", args=[2]))
