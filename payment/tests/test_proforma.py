...
class PaymentModelViewTest(APITestCase):
    ...
    def setUp(self):
        ...
        data_proforma_invoice = {
            "purchase_order_id" : self.purchase_order,
            "buyer_purchase_order_id" : "123131",
            "created_by_user_id" : self.user1,
            "seller_id" : self.seller2,
            "buyer_id" : self.buyer,
            "status" : "issued",
        ...
        ProformaInvoice.objects.create(**data_proforma_invoice)
    
    def test_post_valid_payment_list_proforma(self):
        '''
        ...
        response = self.client.post(reverse("payment:proforma_prepayment" , args=[1,1,1]), data, content_type='application/json')
    ...
    def test_post_invalid_payment_list_proforma(self):
        '''
        posting payment with event 1 and buyer id 1
        '''
        data = {
        ...
        data = json.dumps(data)
        response = self.client.post(reverse("payment:proforma_prepayment" , args=[1,2,1]), data, content_type='application/json')
